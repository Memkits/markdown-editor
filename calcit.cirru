      ...
      :defs $ {}
              ...
              div
                    ...
                    {} (:css |)
                      ...
                      :highlight $ fn (code lang)
                        if (contains? supported-langs lang)
                          .-value $ unsafe-coerce
                            .!highlight hljs code $ {} $ :language (get supported-langs lang)
                            , JsObject
                          escape-html code
                if (not preview?)
                ...
                div ({})
                  ...
                  div
                    ...
                    a
                      {}
                        :href |https://github.com/Memkits/markdown-editor
                        :target |_blank
        ...
        'read-from-dom! $ %{} 'CodeEntry (:doc |)
          :code $ quote $ defn read-from-dom! ()
            let
                el $ unsafe-coerce
                  .-firstChild $ unsafe-coerce
                    js/document.getElementById |article
                    , JsObject
                  , JsObject
              ...
              if-let
                ...
                let
                  ...
                  -> msg .-text $ set! $ join-str (to-calcit-data text-array) &newline
        ...
        'site $ %{} 'CodeEntry (:doc |)
          :code $ quote $ def site
            {}
              ...
              :cdn-url |http://cdn.tiye.me/markdown-editor/
              :title "|Markdown Editor"
              :icon |http://cdn.tiye.me/logo/markdown-editor.png
              :storage-key |markdown-editor
          :examples $ []
          :schema $ :: 'Dynamic
      :ns $ %{} 'NsEntry (:doc |)
